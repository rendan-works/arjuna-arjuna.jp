				...
				<div class="about-intro__inner c-inner-max -contents-lg">
					<div class="about-intro__contents">
						...
						<div class="about-intro__txt">
							<div class="about-intro__txt__cell -unique1">
							...
							<div class="about-intro__txt__cell -unique2">
								<p class="c-crop-v-h-lg">
									アナログコミュニケーションに<br>
				...
				<section class="about-contents">
					<div class="about-contents__flex c-inner-max">
						<div class="about-contents__contents js-trigger">
							...
							<h3 class="about-contents__catch c-crop js-splittext js-var-delay-6">一緒に創り　一緒に育つ</h3>
							...
							<p class="about-contents__txt2 c-txt-lg3 c-crop">デザインとは、単に装飾や芸術を表現することに留まらず、ブランドの価値や経営者の想いを形作る重要な計画を意味します。協力し合いながら、アイデアを共有し、共創・共栄を目指します。</p>
						</div>
						...
						<div class="about-contents__contents js-trigger">
							<header>
								<div class="c-title5 js-fadeups">
									...
									<p class="c-title5__en">MISSION</p>
									<h2 class="c-title5__ja">アルジュナの使命</h2>
								</div>
							</header>
							<h3 class="about-contents__catch c-crop js-splittext js-var-delay-6">クライアントのクロコになる</h3>
							<p class="about-contents__txt c-crop">
							...
							<p class="about-contents__txt2 c-txt-lg3 c-crop">私たちはプロフェッショナルとして技術を磨きつつ、人間らしい温かさと思いやりを忘れずに、クライアントの思いを形にします。</p>
						</div>
						...
						<div class="about-contents__contents js-trigger">
							<header>
								<div class="c-title5 js-fadeups">
									...
									<p class="c-title5__en">VISION</p>
									<h2 class="c-title5__ja">アルジュナが目指す未来</h2>
								</div>
							</header>
							<h3 class="about-contents__catch c-crop js-splittext js-var-delay-6">みんながデザインしたくなる</h3>
							<!-- <p class="about-contents__txt c-crop">デザイン思考で社会との架け橋をつくり、経営者自身が自ずからデザインしていける未来を目指します。</p> -->
							<p class="about-contents__txt2 c-txt-lg3 c-crop">ブランドアイデンティティがビジュアルとして機能しはじめたら、そこからが本当のスタート。デザインが私達デザイナーの手から離れた後、経営者の皆さんが自分たちで考え、自分たちで行動を起こそうとするモチベーションこそがデザイン思考の起因。経営者自身が自らデザインしていける未来が待っています。</p>
						</div>
				...
				<div class="c-inner-max">
					<header>
						<div class="c-title5 js-trigger js-fadeups u-t-center">
							...
							<p class="c-title5__en">LOGO MARK</p>
			...
			<section class="about-prize">
				<div class="c-inner-max">
					...
					<div class="about-prize__table c-table">
						<div>
							<dl>
								<dt class="c-crop -year">2024年</dt>
								<dd class="c-crop">日本タイポグラフィ年鑑入選</dd>
							</dl>
						</div>
						<div>
							<dl>
								<dt class="c-crop -year">2023年</dt>
						...
						<div>
							<dl>
								<dt class="c-crop -year">2022年</dt>
								<dd class="c-crop">長崎デザインアワード銀賞/入選</dd>
							</dl>
						</div>
						<div>
							<dl>
								<dt class="c-crop -year">2021年</dt>
								<dd class="c-crop">長崎デザインアワード入選</dd>
							</dl>
						</div>
						<div>
							<dl>
								<dt class="c-crop -year">2020年</dt>
								<dd class="c-crop">長崎デザインアワード金賞</dd>
							</dl>
						</div>
						<div>
							<dl>
								<dt class="c-crop -year">2019年</dt>
								<dd class="c-crop">長崎デザインアワード審査員特別賞</dd>
							</dl>
						</div>
						<div>
							<dl>
								<dt class="c-crop -year">2018年</dt>
						...
						<div>
							<dl>
								<dt class="c-crop -year">2017年</dt>
								<dd class="c-crop">経済産業庁北海道パッケージデザインコンテストグランプリ</dd>
							</dl>
						</div>
						<div>
							<dl>
								<dt class="c-crop -year">2015年</dt>
								<dd class="c-crop">長崎デザインアワード入選</dd>
							</dl>
						</div>
					</div>
